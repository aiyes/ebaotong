...
public class RenBaoLogin2 {
	...
	public static Map<String,String> get(String url,String encoding,String cookies) throws KeyManagementException, NoSuchAlgorithmException, ClientProtocolException, IOException {  
		 String body = "";  
		    //采用绕过验证的方式处理https请求  
	...
	public static Map<String,String> post(String url, Map<String,String> map,String encoding,String cookies,String referer) throws KeyManagementException, NoSuchAlgorithmException, ClientProtocolException, IOException {  
		...
		//      CloseableHttpClient client = HttpClients.createDefault();  
		    ...
		    System.out.println("--------post--response--header----");
		    System.out.println(JSON.toJSONString(response));
    ...
    public static void main(String[] args) throws Exception {
    	String url = "http://10.134.130.208/portal/index.jsp?time="+System.currentTimeMillis();
        //String url = "https://10.134.130.208:8888/casserver/login?service=http://10.134.130.208/portal/index.jsp";
    	String UTF8="utf-8";
    	Map<String,String> map1 =  get(url,UTF8,null);
    	String body = map1.remove("body");
        ...
        String cookies ="prpall="+userCode+"; JSESSIONID="+map1.get("JSESSIONID");
        ...
        String cookies2 = "prpall="+userCode+"; JSESSIONID="+map1.get("JSESSIONID");
        Map<String,String> map2 = post(loginUrl,loginParams, UTF8,cookies2,url);
        String body2 = map2.remove("body");
        ...
        //String homePageUrl = "http://10.134.130.208:8000/prpall/index.jsp?ticket="+ticket;
        String homePageUrl = "http://10.134.130.208:8000/prpall/style/mian_demo.css?ticket="+ticket;
        System.out.println("homePageUrl-->"+homePageUrl);
        String jsessinon3 = map2.get("JSESSIONID")==null?map1.get("JSESSIONID"):map2.get("JSESSIONID");
        String cookies3 = "prpall="+userCode+"; JSESSIONID="+jsessinon3;
        Map<String,String> map3 = get(homePageUrl,UTF8,cookies3);
        String body3 = map3.remove("body");
