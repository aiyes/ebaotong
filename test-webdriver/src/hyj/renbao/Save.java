 ...
 * @Description: TODO()
 * @author yejie.huang
 * @date 2016年11月30日 上午10:13:19
 *
 */

public class Save {
	public static Map<String,String> getSaveParams(String randomProposalNo){
		...
		params1.put("prpCmain.riskCode","DAA");
		...
		params1.put("prpCinsureds_[0].insuredName","张力行1");
		...
		params1.put("prpCinsureds[0].insuredName","张力行1");
		...
		params1.put("prpCmainCar.agreeDriverFlag","0");
		...
		params1.put("prpCmainCommon.groupFlag","3");
		...
		params1.put("prpCcarShipTax.taxPayerName","张力行1");
		...
		params1.put("maxRateScm","45");
		params1.put("levelMaxRateCi","");
		params1.put("maxRateScmCi","4");
		...
		params1.put("prpCcommissionsTemp_[0].costType","2");
		params1.put("prpCcommissionsTemp_[0].riskCode","DZA");
		params1.put("prpCcommissionsTemp_[0].adjustFlag","0");
		params1.put("prpCcommissionsTemp_[0].auditRate","");
		params1.put("prpCcommissionsTemp_[0].sumPremium","950");
		params1.put("prpCcommissionsTemp_[0].costRate","4");
		params1.put("prpCcommissionsTemp_[0].costRateUpper","4");
		params1.put("prpCcommissionsTemp_[0].coinsRate","100");
		params1.put("prpCcommissionsTemp_[0].coinsDeduct","1");
		params1.put("prpCcommissionsTemp_[0].costFee","35.85");
		params1.put("prpCcommissionsTemp_[0].agreementNo","RULE20164403000000018");
		params1.put("prpCcommissionsTemp_[0].configCode","PUB");
		params1.put("prpCcommissionsTemp[0].costType","2");
		params1.put("prpCcommissionsTemp[0].riskCode","DAA");
		params1.put("prpCcommissionsTemp[0].adjustFlag","0");
		params1.put("prpCcommissionsTemp[0].auditRate","");
		params1.put("prpCcommissionsTemp[0].sumPremium","6200.19");
		params1.put("prpCcommissionsTemp[0].costRate","45");
		params1.put("prpCcommissionsTemp[0].costRateUpper","45");
		params1.put("prpCcommissionsTemp[0].coinsRate","100");
		params1.put("prpCcommissionsTemp[0].costFee","2632.16");
		params1.put("prpCcommissionsTemp[0].agreementNo","RULE20164403000000055");
		params1.put("prpCcommissionsTemp[0].configCode","PUB");
		params1.put("prpCcommissionsTemp[1].costType","2");
		params1.put("prpCcommissionsTemp[1].riskCode","DZA");
		params1.put("prpCcommissionsTemp[1].adjustFlag","0");
		params1.put("prpCcommissionsTemp[1].auditRate","");
		params1.put("prpCcommissionsTemp[1].sumPremium","950");
		params1.put("prpCcommissionsTemp[1].costRate","4");
		params1.put("prpCcommissionsTemp[1].costRateUpper","4");
		params1.put("prpCcommissionsTemp[1].coinsRate","100");
		params1.put("prpCcommissionsTemp[1].costFee","35.85");
		params1.put("prpCcommissionsTemp[1].agreementNo","RULE20164403000000018");
		params1.put("prpCcommissionsTemp[1].configCode","PUB");
		...
		params1.put("prpDdismantleDetails_[0].id.agreementNo","RULE20164403000000018");
		params1.put("prpDdismantleDetails_[0].flag","DZA");
		params1.put("prpDdismantleDetails_[0].id.configCode","PUB");
		params1.put("prpDdismantleDetails_[0].id.assignType","1");
		params1.put("prpDdismantleDetails_[0].id.roleCode","440321100061");
		params1.put("prpDdismantleDetails_[0].roleName","深圳市宜保通保险销售有限公司");
		params1.put("prpDdismantleDetails_[0].costRate","100");
		params1.put("prpDdismantleDetails_[0].roleFlag","1");
		params1.put("prpDdismantleDetails_[0].businessNature","2");
		params1.put("prpDdismantleDetails_[0].roleCode_uni","");
		params1.put("hidden_index_prpDdismantleDetails","0");
		params1.put("prpDdismantleDetails[0].id.agreementNo","RULE20164403000000055");
		params1.put("prpDdismantleDetails[0].flag","DAA");
		params1.put("prpDdismantleDetails[0].id.configCode","PUB");
		params1.put("prpDdismantleDetails[0].id.assignType","1");
		params1.put("prpDdismantleDetails[0].id.roleCode","440321100061");
		params1.put("prpDdismantleDetails[0].roleName","深圳市宜保通保险销售有限公司");
		params1.put("prpDdismantleDetails[0].costRate","100");
		params1.put("prpDdismantleDetails[0].roleFlag","1");
		params1.put("prpDdismantleDetails[0].businessNature","2");
		params1.put("prpDdismantleDetails[0].roleCode_uni","");
		params1.put("prpDdismantleDetails[1].id.agreementNo","RULE20164403000000018");
		params1.put("prpDdismantleDetails[1].flag","DZA");
		params1.put("prpDdismantleDetails[1].id.configCode","PUB");
		params1.put("prpDdismantleDetails[1].id.assignType","1");
		params1.put("prpDdismantleDetails[1].id.roleCode","440321100061");
		params1.put("prpDdismantleDetails[1].roleName","深圳市宜保通保险销售有限公司");
		params1.put("prpDdismantleDetails[1].costRate","100");
		params1.put("prpDdismantleDetails[1].roleFlag","1");
		params1.put("prpDdismantleDetails[1].businessNature","2");
		params1.put("prpDdismantleDetails[1].roleCode_uni","");
		params1.put("payTimes","1");
		params1.put("prpCplanTemps_[0].payNo","1");
		params1.put("prpCplanTemps_[0].serialNo","0");
		params1.put("prpCplanTemps_[0].endorseNo","");
		params1.put("cplan_[0].payReasonC","收保费");
		params1.put("prpCplanTemps_[0].payReason","R21");
		params1.put("prpCplanTemps_[0].planDate","2016-11-30");
		params1.put("prpCplanTemps_[0].currency","CNY");
		params1.put("description_[0].currency","人民币");
		params1.put("prpCplanTemps_[0].planFee","6200.19");
		params1.put("cplans_[0].planFee","6200.19");
		params1.put("cplans_[0].backPlanFee","6200.19");
		params1.put("prpCplanTemps_[0].netPremium","5849.25");
		params1.put("prpCplanTemps_[0].taxPremium","350.94");
		params1.put("prpCplanTemps_[0].delinquentFee","6200.19");
		params1.put("prpCplanTemps_[0].flag","");
		params1.put("prpCplanTemps_[0].subsidyRate","0");
		params1.put("prpCplanTemps_[0].isBICI","BI");
		params1.put("iniPrpCplan_Flag","");
		params1.put("loadFlag9","");
		params1.put("planfee_index","0");
		params1.put("prpCplanTemps[0].payNo","1");
		params1.put("prpCplanTemps[0].serialNo","0");
		params1.put("prpCplanTemps[0].endorseNo","");
		params1.put("cplan[0].payReasonC","(强制)收保费");
		params1.put("prpCplanTemps[0].payReason","R29");
		params1.put("prpCplanTemps[0].planDate","2016-11-30");
		params1.put("prpCplanTemps[0].currency","CNY");
		params1.put("description[0].currency","人民币");
		params1.put("prpCplanTemps[0].planFee","950");
		params1.put("cplans[0].planFee","950");
		params1.put("cplans[0].backPlanFee","950");
		params1.put("prpCplanTemps[0].netPremium","896.23");
		params1.put("prpCplanTemps[0].taxPremium","53.77");
		params1.put("prpCplanTemps[0].delinquentFee","950");
		params1.put("prpCplanTemps[0].flag","");
		params1.put("prpCplanTemps[0].subsidyRate","0");
		params1.put("prpCplanTemps[0].isBICI","CI");
		params1.put("prpCplanTemps[1].payNo","1");
		params1.put("prpCplanTemps[1].serialNo","0");
		params1.put("prpCplanTemps[1].endorseNo","");
		params1.put("cplan[1].payReasonC","代收车船税");
		params1.put("prpCplanTemps[1].payReason","RM9");
		params1.put("prpCplanTemps[1].planDate","2016-11-30");
		params1.put("prpCplanTemps[1].currency","CNY");
		params1.put("description[1].currency","人民币");
		params1.put("prpCplanTemps[1].planFee","70");
		params1.put("cplans[1].planFee","70");
		params1.put("cplans[1].backPlanFee","70");
		params1.put("prpCplanTemps[1].netPremium","");
		params1.put("prpCplanTemps[1].taxPremium","");
		params1.put("prpCplanTemps[1].delinquentFee","70");
		params1.put("prpCplanTemps[1].flag","");
		params1.put("prpCplanTemps[1].subsidyRate","0");
		params1.put("prpCplanTemps[1].isBICI","CShip");
		params1.put("prpCplanTemps[2].payNo","1");
		params1.put("prpCplanTemps[2].serialNo","0");
		params1.put("prpCplanTemps[2].endorseNo","");
		params1.put("cplan[2].payReasonC","收保费");
		params1.put("prpCplanTemps[2].payReason","R21");
		params1.put("prpCplanTemps[2].planDate","2016-11-30");
		params1.put("prpCplanTemps[2].currency","CNY");
		params1.put("description[2].currency","人民币");
		params1.put("prpCplanTemps[2].planFee","6200.19");
		params1.put("cplans[2].planFee","6200.19");
		params1.put("cplans[2].backPlanFee","6200.19");
		params1.put("prpCplanTemps[2].netPremium","5849.25");
		params1.put("prpCplanTemps[2].taxPremium","350.94");
		params1.put("prpCplanTemps[2].delinquentFee","6200.19");
		params1.put("prpCplanTemps[2].flag","");
		params1.put("prpCplanTemps[2].subsidyRate","0");
		params1.put("prpCplanTemps[2].isBICI","BI");
		params1.put("planStr","");
		...
		params1.put("prpCsettlement.flag","0");
